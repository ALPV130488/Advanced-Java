...
public class PersonServiceImplServiceLocator extends org.apache.axis.client.Service implements com.soapexample.service.PersonServiceImplService {
    ...
    public com.soapexample.service.PersonServiceImpl getPersonServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.soapexample.service.PersonServiceImplSoapBindingStub _stub = new com.soapexample.service.PersonServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.soapexample.service.PersonServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.soapexample.service.PersonServiceImplSoapBindingStub _stub = new com.soapexample.service.PersonServiceImplSoapBindingStub(new java.net.URL(PersonServiceImpl_address), this);
                _stub.setPortName(getPersonServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.soapexample.com", "PersonServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.soapexample.com", "PersonServiceImpl"));
        }
